...
@Setter
@NoArgsConstructor
@JsonIgnoreProperties({"password", "authorities","ruolo","squadre","partecipazioni","partite","statistiche","risultati", "enabled", "accountNonExpired", "credentialsNonExpired", "accountNonLocked"})
